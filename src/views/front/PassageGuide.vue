      ...
      <div style="flex: 1;" class="card">
        ...
        <div class="blog-box" v-for="item in tableData" :key="item.id" v-if="total > 0" style="display: flex;">
          <div style="flex: 1; width: 0">
            ...
            <div class="line1" style="font-size: 16px; color: #666; margin-bottom: 10px;" v-html="item.content"></div>
        ...
        <div class="card" style="margin-bottom: 10px">
          ...
          <div>
            <div v-for="item in showList" :key="item.id" style="margin: 15px 0; " class="line1">
                  ...
                  <a :href="'/passageDetail?passageId=' + item.passageId" target="_blank"><span>{{ item.title }}</span></a>
  ...
  methods: {
    ...
    queryPassage() {
      ...
      if(this.queryParam !== null){
        params.append('title',this.queryParam)
        params.append('content',this.queryParam)
        params.append('label',this.queryParam)
      }else if(this.current !== null && this.current !== '全部博客'){
